...
function createTriggerVisualizer(position, left, top, width, height) {
    ...
    visualizer.className = 'trigger-area-visualizer';
    ...
    visualizer.style.background = 'rgba(255, 0, 0, 0.5)';
    visualizer.style.border = '1px dashed red';
    visualizer.style.zIndex = '9999';
    visualizer.style.pointerEvents = 'none'; // don't interfere with mouse events
...
function visualizeAuthorRegion(regionWidth, regionHeight) {
    ...
    regionVisualizer.className = 'region-visualizer';
    regionVisualizer.style.position = 'absolute';
    regionVisualizer.style.border = '2px dashed blue';
    regionVisualizer.style.background = 'rgba(0, 0, 255, 0.1)';
    regionVisualizer.style.zIndex = '9998'; // below the edge triggers
    regionVisualizer.style.pointerEvents = 'none'; // don't interfere with mouse events
...
function visualizePanBoundaries() {
    ...
    boundaryVisualizer.className = 'region-visualizer';
    boundaryVisualizer.style.position = 'absolute';
    boundaryVisualizer.style.border = '2px dashed green';
    boundaryVisualizer.style.background = 'rgba(0, 255, 0, 0.05)';
    boundaryVisualizer.style.zIndex = '9997'; // below the author region visualizer
    boundaryVisualizer.style.pointerEvents = 'none'; // don't interfere with mouse events
...
function createPanningDebugControls() {
    ...
    dragSensLabel.style.display = 'block';
    dragSensLabel.style.marginBottom = '5px';
    dragSensLabel.style.fontSize = '10px';
    ...
    dragSensSlider.style.width = '100%';
    ...
    edgeSensLabel.style.display = 'block';
    edgeSensLabel.style.marginBottom = '5px';
    edgeSensLabel.style.marginTop = '10px';
    edgeSensLabel.style.fontSize = '10px';
    ...
    edgeSensSlider.style.width = '100%';
    ...
    zoomSpeedLabel.style.display = 'block';
    zoomSpeedLabel.style.marginBottom = '5px';
    zoomSpeedLabel.style.marginTop = '10px';
    zoomSpeedLabel.style.fontSize = '10px';
    ...
    zoomRangeLabel.style.display = 'block';
    zoomRangeLabel.style.marginBottom = '5px';
    zoomRangeLabel.style.marginTop = '10px';
    zoomRangeLabel.style.fontSize = '10px';
    ...
    minScaleLabel.style.display = 'block';
    minScaleLabel.style.fontSize = '10px';
    ...
    minScaleSlider.style.width = '100%';
    ...
    maxScaleLabel.style.display = 'block';
    maxScaleLabel.style.marginTop = '5px';
    maxScaleLabel.style.fontSize = '10px';
    ...
    maxScaleSlider.style.width = '100%';
    ...
    regionHeader.style.marginTop = '15px';
    regionHeader.style.marginBottom = '5px';
    regionHeader.style.fontSize = '12px';
    ...
    boundaryEnabledLabel.style.display = 'block';
    boundaryEnabledLabel.style.fontSize = '10px';
    ...
    boundaryEnabledCheckbox.addEventListener('change', (e) => {
        ...
        boundaryEnabledLabel.textContent = `enable region boundaries: ${panBoundaries.enabled ? 'yes' : 'no'}`;
        
        // enable/disable boundary sliders
    ...
    boundaryEnabledLabel.appendChild(document.createTextNode(' enable region boundaries'));
    ...
    boundaryMinXLabel.style.display = 'block';
    boundaryMinXLabel.style.fontSize = '10px';
    boundaryMinXLabel.style.marginTop = '5px';
    ...
    boundaryMinXSlider.style.width = '100%';
    boundaryMinXSlider.disabled = !panBoundaries.enabled;
    ...
    boundaryMaxXLabel.style.display = 'block';
    boundaryMaxXLabel.style.fontSize = '10px';
    boundaryMaxXLabel.style.marginTop = '5px';
    ...
    boundaryMaxXSlider.style.width = '100%';
    boundaryMaxXSlider.disabled = !panBoundaries.enabled;
    ...
    boundaryMinYLabel.style.display = 'block';
    boundaryMinYLabel.style.fontSize = '10px';
    boundaryMinYLabel.style.marginTop = '5px';
    ...
    boundaryMinYSlider.style.width = '100%';
    boundaryMinYSlider.disabled = !panBoundaries.enabled;
    ...
    boundaryMaxYLabel.style.display = 'block';
    boundaryMaxYLabel.style.fontSize = '10px';
    boundaryMaxYLabel.style.marginTop = '5px';
    ...
    boundaryMaxYSlider.style.width = '100%';
    boundaryMaxYSlider.disabled = !panBoundaries.enabled;
